...
<body>
    ...
    <form action="/">
      ...
      <button type="submit" class="btn" text-color="white"><a href="http://localhost:8080/login">Register</a></button>
      <p>Already registered with us ?<a href="http://localhost:8080/login">Login here</a></p>
    </form>
</body>
</html>